...
public class DoubleCrosswordCarnivalGAWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(DoubleCrosswordCarnivalGAWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/DoubleCrosswordGAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/DoubleCrosswordGAIW/InitOutcome.xml").getDocumentElement();
